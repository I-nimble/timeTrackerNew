...
import { Mailbox } from 'src/app/legacy/pages/apps/email/email';
import { mailboxList } from 'src/app/legacy/pages/apps/email/email-data';
import { User } from 'src/app/legacy/pages/apps/email/user-data';
