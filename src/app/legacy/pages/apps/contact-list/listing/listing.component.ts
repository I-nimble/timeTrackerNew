...
import { AppSearchDialogComponent } from 'src/app/legacy/layouts/full/vertical/header/header.component';
import { ContactBox } from 'src/app/legacy/pages/apps/contact-list/contact-list';
import { ContactService } from 'src/app/legacy/services/apps/contact-list/contact-list.service';
