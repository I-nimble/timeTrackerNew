...
import { AppCodeViewComponent } from 'src/app/legacy/components/code-view/code-view.component';

// snippets
import {
  PROGRESS_BUFFER_HTML_SNIPPET,
  PROGRESS_CONFIGURABLE_HTML_SNIPPET,
  PROGRESS_DETERMINATE_HTML_SNIPPET,
  PROGRESS_INDETERMINATE_HTML_SNIPPET,
  PROGRESS_QUERY_HTML_SNIPPET,
} from './code/progress-html-snippet';
import {
  PROGRESS_CONFIGURABLE_TS_SNIPPET,
  PROGRESS_DETERMINATE_TS_SNIPPET,
} from './code/progress-ts-snippet';
