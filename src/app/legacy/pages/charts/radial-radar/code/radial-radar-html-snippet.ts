export const RADIALBAR_CHART_HTML_SNIPPET = `  <apx-chart [series]="radialbarChartOptions.series" [chart]="radialbarChartOptions.chart"
...
export const RADAR_CHART_HTML_SNIPPET = `  <apx-chart [series]="radarChartOptions.series" [chart]="radarChartOptions.chart"
