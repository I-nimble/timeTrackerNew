...
import { SharedModule } from 'src/app/legacy/components/shared.module';
import { ToDoFormPopupComponent } from 'src/app/legacy/components/to-do-form-popup/to-do-form-popup.component';
import { Entry } from 'src/app/legacy/models/Entries';
