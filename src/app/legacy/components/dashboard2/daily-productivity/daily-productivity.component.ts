...
import { EntriesService } from '@legacy/services/entries.service';
import { SchedulesService } from '@legacy/services/schedules.service';
import { UsersService } from '@legacy/services/users.service';
...
export class AppDailyProductivityComponent implements OnInit {
