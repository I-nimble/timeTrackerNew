export const environment = {
  ...
  stripePublicKey:
    'pk_test_51RoRhYA7lAmLJd56IjAbCmMWMtjh7iLIVxMLav5vCeBjGaTBlRFyAErXSeGtRLFNx49mmwWSOc9cnJHnXUsRT9VV00joP4DxQo',
  firebaseConfig: {
  ...
  vapidKey:
    'BAgM65bd3u0eip66PuUViB9xB4agoBNFqTOragNBofHJnz7BcZM4SJqoSZyu2gj8Aiz573ExvVDwfU_eICWf2JI',
  allowedReportEmails: [
    'pgarcia@i-nimble.com',
    'jnava@i-nimble.com',
    'sgutierrez@i-nimble.com',
    'mfernanda@i-nimble.com',
  ],
  allowedPaymentsEmails: [
    'jpalma@i-nimble.com',
    'sgutierrez@i-nimble.com',
    'ffernandez@i-nimble.com',
  ],
  groupCreatorEmails: ['ffernandez@i-nimble.com', 'sgutierrez@i-nimble.com'],
  allowedContentCreatorEmails: [
    'apalma@i-nimble.com',
    'pgimmigrationservices@gmail.com',
    'pete@rollwithpunch.com',
    'ffernandez@i-nimble.com',
  ],
  developmentTeamEmails: [
    'sgutierrez@i-nimble.com',
    'ffernandez@i-nimble.com',
    'sbracho@i-nimble.com',
    'npena@i-nimble.com',
    'adiaz@i-nimble.com',
  ],
  ...
  rocketChatS3Bucket:
    'https://inimble-chat.s3.us-east-1.amazonaws.com/f87be79d-b1cc-41f7-922b-cf132b4199fb',
